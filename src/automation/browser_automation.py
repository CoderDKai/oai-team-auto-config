...
from src.email.email_service import unified_get_verification_code
from src.crs.crs_service import (
    crs_generate_auth_url,
    crs_exchange_code,
    crs_add_account,
    extract_code_from_url,
)
from src.cpa.cpa_service import (
        ...
        for attempt in ctx.attempts():
            try:
                ...
                if AUTH_PROVIDER == "cpa":
                    ...
                    if codex_data:
                        from src.crs.crs_service import crs_add_account
